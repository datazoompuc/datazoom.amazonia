...
#      resolved under the old 5-tier code -- this was checked at the time
#      against a captured golden matrix (resolution_matrix_tiered.rds,
#      generated by the now-deleted capture_resolution_matrix.R), since
#      retired along with the base-row concept it depended on; see
#      test-resolution-matrix-v2.R for the current equivalent.
