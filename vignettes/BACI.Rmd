...
Loads disaggregated data on bilateral trade flows for more than 5000 products and 200 countries. The data is from the [CEPII](https://www.cepii.fr/CEPII/en/bdd_modele/bdd_modele_item.asp?id=37&id=37) and is built from data directly reported by each country to the United Nations Statistical Division (Comtrade).
