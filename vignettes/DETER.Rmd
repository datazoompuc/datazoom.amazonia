...
load_deter("amazonia", aggregation_level = "municipality", language = "eng")
```

Note that data extracted via 'load_deter_raw()' retains some additional information on the satellites used, as well as a variable saying which Conservation Unit was affected in each warning, if any.
