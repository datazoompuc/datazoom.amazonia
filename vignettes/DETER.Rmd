...
### Example 1: Download DETER Amazon data
...
### Example 2: Download DETER Cerrado data
...
### Example 3: Load both biomes and combine

```{r eval=FALSE}
# load Amazon and Cerrado data and combine into a single data frame
...
combined <- dplyr::bind_rows(
  dplyr::mutate(amazon_data, biome = "Amazon"),
  dplyr::mutate(cerrado_data, biome = "Cerrado")
)
```
