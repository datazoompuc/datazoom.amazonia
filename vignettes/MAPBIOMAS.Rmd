...
data <- load_mapbiomas_cobertura(aggregation_level = 'municipality', path = NULL, covering = 3, type = 'stacked', years = c(2000:2010))

data <- load_mapbiomas_transicao(path = NULL, covering_from = 3, covering_to = 19, type = 'normal', year_diff = 5)
