...
### Example 1: Overall social progress for the most recent year

```{r eval=FALSE}
# download complete IPS data for 2023
ips_data <- load_ips(
  dataset = "all",
  raw_data = FALSE,
  time_period = 2023,
...
### Example 2: Education indicators across multiple years

```{r eval=FALSE}
# download education indicators for 2018, 2021 and 2023
...
### Example 3: Deforestation indicators for all available years
...
### Example 4: Violence indicators in Portuguese

```{r eval=FALSE}
# download violence indicators for 2023 in Portuguese
