...
The source is ANEEL's own CKAN Open Data catalogue (`siga-empreendimentos-geracao.csv`). Power and coordinate columns (`mda_*`/`num_coord_*`) are automatically converted to numeric values.
