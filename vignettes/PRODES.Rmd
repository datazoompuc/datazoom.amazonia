...
[PRODES](https://www.gov.br/inpe/pt-br) (Projeto de Monitoramento da Floresta Amazônica Brasileira - Project for Monitoring the Brazilian Amazon Forest) is Brazil's primary satellite-based deforestation monitoring system operated by [INPE](https://www.inpe.br/) (National Institute for Space Research).
...
- **Long time series**: Available from 2007 onwards (cumulative) and incrementally by year, currently through 2025
...
For more information, visit [INPE PRODES Project](https://www.gov.br/inpe/pt-br) and [TerraBrasilis](https://terrabrasilis.dpi.inpe.br/).
...
`inst/extdata/manifest/v1/datasets_link.csv` -- and move forward every time `resolve_prodes.R`
picks up a new PRODES release; re-check them here if this doc goes stale again)
...
5. **Recent data provisional**: the most recent year's data may be subject to revision as final processing completes
