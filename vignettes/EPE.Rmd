...
*Note that there are no consumer data for 'Captive' class at all.
...
The dataset has information at the Brazilian state level, including the Federal District, from 2011 to 2021 and also indicates if the state is in the Legal Amazon.
...
**Options:**
  ...
  1. **dataset**: there are two choices:
      * `"energy_consumption_per_class"`: energy consumption and consumers by State, Region or Electric Subsystem
