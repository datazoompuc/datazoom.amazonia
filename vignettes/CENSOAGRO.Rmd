...
### Example 1: Agricultural land area by state
...
### Example 2: Temporary crop production by state

```{r eval=FALSE}
# download treated temporary crop data by state for multiple census years
data <- load_censoagro(
...
### Example 3: Livestock production by municipality
