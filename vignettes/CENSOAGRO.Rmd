...
- **Time period**: 1920, 1940, 1950, 1960, 1970, 1975, 1980, 1985, 1995, 2006
...
- **Time period**: 1940 onwards (1940, 1950, 1960, 1970, 1975, 1980, 1985, 1995, 2006)
- **Geographic levels**: Country, State
...
- **Geographic levels**: **Municipality only** -- unlike every other dataset in this vignette,
  `livestock_production` is not available at the country or state level
...
- `"municipality"`: Available only for `"livestock_production"`, and the *only* level that
  dataset supports -- `"country"`/`"state"` are not available for `livestock_production`
