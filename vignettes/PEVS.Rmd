...
There are five parameters in this function:
  ...
  5. language: you can choose between portuguese and english
   ...
   WARNING: These files contain a lot of information and are quite heavy. If argument "time_period" represents a long time span or "geo_level" is set to "municipality",   downloading may take a while.
...
data <- load_pevs(dataset = 'pevs_silviculture', 
                  ...
                  time_period = 2012, 
                  language = "pt")
# Download raw (raw_data = TRUE) forest crops data (dataset = 'pevs_forest_crops') by municipality (geo_level = 'region') from 2012 to 2013 (time_period = 2012:2013) in english (language = "eng")
