...
There are four parameters in this function:
  ...
  1. dataset: There are five choices:
  # "seeg_farming"
  # "seeg_industry"
  # "seeg_energy"
  # "seeg_land"
...
```{r eval=FALSE}
# Download raw data (raw_data = TRUE) of farming greenhouse gases (dataset = "seeg_farming") by municipality (geo_level = "municipality")
...
# Download raw data (raw_data = TRUE) of residuals greenhouse gases (dataset = "seeg_residuals") by municipality (geo_level = "municipality")
data <- load_seeg(dataset = "seeg_residuals", 
                  raw_data = TRUE,
                  geo_level = "municipality")
```
...
# 8) PIBMUNIC
Loads GDP data at current prices of the three large sectors of economic activity - Agriculture, Industry and Services - as well as taxes, net of subsidies, GDP and GDP per capita.
