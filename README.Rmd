...
|||
|---|---|
| **PRODES** | _Yearly deforestationn_ |
| **DETER** | _Alerts on forest cover changes_ |
| **DEGRAD** | _Forest degradation_ |
...
| **IBAMA** | _Environmental fines_ |
| **MAPBIOMAS** | _Land cover and use_ |
| **TerraClimate** | _Climate data such as temperature_ |
