...
**[14 - IBAMA MULTAS data](#14---ibama_multas)**
...
Loads data on environmental distributed and collected fines at the municipality/state level considering all regions. 

```
There are five parameters in this function:
  
  1. dataset:
  # "distributed_fines" has data on fines that have not been paid

  2. raw_data: there are two options:
  # TRUE: data on its original form.
  # FALSE: if you want the treated (more organized) version of the data.
  ...
  4. uf:
  # Here, you select the Brazilian state on which you wish to find information. It can be for example "BA" for Bahia State or "RJ" for Rio de Janeiro State. Always follows this two-letter pattern.
