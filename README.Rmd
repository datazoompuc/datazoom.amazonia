...
| **[Imazon](###imazon)** | _Deforestation in the Legal Amazon_ |

</td><td>

|||
|---|---|
| **IBAMA** | _Environmental fines and punished companies_ |
| **MAPBIOMAS** | _Land cover and land use_ |
| **TerraClimate** | _Climate data_ |
| **SEEG** | _Greenhouse gas emission estimates_ |
...
|||
|---|---|
| **IPS** | _Amazon Social Progress Index_ |
| **DATASUS** | _Causes of mortality and availability of hospital beds_ |
| **IEMA** | _Access to electricity in the Amazon region_ |
...
|||
|---|---|
| **[COMEX](#2---comex)** | _Brazilian international trade_ |
| **BACI** | _Worldwide international trade_ |
| **PIB-Munic** | _Municipal GDP_ |
| **CEMPRE** | _Central register of companies_ |

</td><td>

|||
|---|---|
| **PAM** | _Agricultural production_ |
| **PEVS** | _Forestry and extraction_ |
| **PPM** | _Livestock farming_ |
| **SIGMINE** | _Mining_ |
...
### DETER: 
Loads information on changes of forest cover in the Amazon. 
...
state levels considering the Brazilian region. 
