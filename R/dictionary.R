load_dictionary <- function(dataset) {
  ...
  if (stringr::str_detect(dataset, "datasus_siasus")) {
    ...
    harmonization_dat <- tibble::tribble(
      ...
      "ap_condic",    "sigla_tipo_gestao", "management_type_code",  "sigla do tipo de gestão",                                        "management type code",
      "ap_gestao",    "cod_uf_mun_gestor", "manager_uf_muni_code",  "código da UF + município de gestão ou UF0000",                   "UF + municipality of management or UF0000",
      "ap_coduni",    "cod_estab_cnes",    "estab_cnes_code",      "código do estabelecimento no CNES",                              "establishment CNES code",
      "ap_autoriz",   "num_apac",          "apac_number",          "número da APAC",                                                  "APAC number",
      "ap_cmp",       "data_competencia",  "competence_date",      "data de atendimento / competência",                               "competence date",
      ...
      "ap_ufmun",     "cod_uf_mun_estab",  "estab_uf_muni_code",   "código da UF + município do estabelecimento",                    "UF + municipality of establishment",
      ...
      "ap_cnspcn",    "cns_paciente",      "patient_cns",         "número do CNS do paciente",                                       "patient's CNS number",
      "ap_coidade",   "cod_idade",         "age_code",            "código da idade",                                                 "age code",
      "ap_nuidade",   "num_idade",         "age_number",          "número da idade",                                                 "age number",
      "ap_sexo",      "sexo_paciente",     "patient_gender",      "sexo do paciente",                                                "patient gender",
      "ap_racacor",   "raca_cor",          "race_color",          "raça/cor do paciente",                                            "patient race/color",
      "ap_munpcn",    "mun_res_paciente",  "patient_res_muni",    "UF + município de residência do paciente",                        "UF + patient residence municipality",
      ...
      "ap_mndif",     "mun_diferente",     "different_muni",      "município do paciente diferente do estabelecimento",              "residence municipality different from establishment",
      "ap_dtinic",    "data_inicio_validade","start_validity_date","data de início da validade",                                     "start date of validity",
      ...
      "ap_motsai",    "motivo_saida",      "exit_reason",         "motivo de saída / permanência",                                   "exit and permanence reason",
      "ap_obito",     "indicador_obito",   "death_flag",          "indicador de óbito",                                             "death indicator",
      "ap_encerr",    "indicador_encerramento","closure_flag",    "indicador de encerramento",                                      "closure indicator",
      "ap_perman",    "indicador_permanencia","permanence_flag",   "indicador de permanência",                                       "permanence indicator",
      "ap_alta",      "indicador_alta",     "discharge_flag",      "indicador de alta",                                              "discharge indicator",
      "ap_transf",    "indicador_transferencia","transfer_flag",   "indicador de transferência",                                     "transfer indicator",
      "ap_dtocor",    "data_ocorrencia",   "occurrence_date",     "data de ocorrência",                                             "date of occurrence",
      "ap_codemi",    "cod_orgao_emissor", "issuer_org_code",     "código do órgão emissor",                                       "issuer agency code",
      "ap_catend",    "carater_atendimento","care_character",     "caráter do atendimento",                                         "nature of care",
      "ap_apacant",   "num_apac_anterior", "previous_apac_number","número da APAC anterior",                                       "previous APAC number",
      "ap_unisol",    "cod_estab_solic",   "requesting_estab_code","código do estabelecimento solicitante",                        "requesting establishment code",
      "ap_dtsolic",   "data_solicitacao",  "request_date",        "data da solicitação",                                            "request date",
      "ap_dtaut",     "data_autorizacao",  "authorization_date",  "data da autorização",                                            "authorization date",
      ...
      "ap_cidsec",    "cid_secundario",    "secondary_cid",       "CID secundário",                                                 "secondary CID",
      ...
      #ACF
      "acf_duplex",   "duplex_previo",        "prior_duplex",         "duplex prévio (S - Sim, N - Não)",                      "previous duplex (Y/N)",
      "acf_usocat",   "uso_cateter_previo",   "prior_catheter_use",   "uso do cateter venoso ou outros acessos prévios (S/N)",  "use of prior catheter or venous access (Y/N)",
      "acf_prefav",   "fav_previa",           "prior_fav",            "fístula arteriovenosa prévia (S/N)",                     "prior AV fistula (Y/N)",
      ...
      "acf_veiavi",   "veia_visivel",         "visible_vein",         "veia visível (S/N)",                                     "visible vein (Y/N)",
      "acf_pulso",    "presenca_pulso",       "presence_pulse",       "presença de pulso (S/N)",                                "presence of pulse (Y/N)",
      "acf_veidia",   "diametro_veia",        "vein_diameter_mm",     "diâmetro da veia (mm)",                                  "vein diameter (mm)",
      "acf_artdia",   "diametro_arteria",     "artery_diameter_mm",   "diâmetro da artéria (mm)",                               "artery diameter (mm)",
      "acf_fremit",   "presenca_fremito",     "presence_thrill",      "frêmito (vibração perceptível pelo tato)",               "thrill (palpable vibration)",
      "ap_natjur",    "natureza_juridica",    "legal_nature_code",    "código da natureza jurídica",                            "legal nature code",

      #AB
      "ar_smrd",      "cod_smrd",          "smrd_code",           "campo reservado (sem descrição)",                               "reserved field (no description)",
      ...
      "ar_estadi",    "estadio_uicc",      "uicc_stage",          "estádio - UICC",                                                "UICC stage",
      "ar_grahis",    "grau_histopatologico","histopath_grade",    "grau histopatológico",                                         "histopathological grade",
      "ar_dtiden",    "data_id_patologica","pathology_ident_date","data de identificação patológica",                              "pathological identification date",
      "ar_trante",    "tratamento_anterior","previous_treatment", "tratamentos anteriores",                                        "previous treatments",
      "ar_cidini1",   "cid_tratamento1",   "first_treat_cid",     "CID do 1º tratamento anterior",                                 "CID of 1st previous treatment",
      "ar_dtini1",    "data_inicio_trat1", "start_treat1_date",   "data de início do 1º tratamento",                               "start date of 1st treatment",
      "ar_cidini2",   "cid_tratamento2",   "second_treat_cid",    "CID do 2º tratamento anterior",                                 "CID of 2nd previous treatment",
      "ar_dtini2",    "data_inicio_trat2", "start_treat2_date",   "data de início do 2º tratamento",                               "start date of 2nd treatment",
      "ar_cidini3",   "cid_tratamento3",   "third_treat_cid",     "CID do 3º tratamento anterior",                                 "CID of 3rd previous treatment",
      "ar_dtini3",    "data_inicio_trat3", "start_treat3_date",   "data de início do 3º tratamento",                               "start date of 3rd treatment",
      "ar_conttr",    "continuidade_tratamento","treatment_continuity","continuidade do tratamento",                               "treatment continuity",
      "ar_dtintr",    "data_inicio_tratamento","treatment_start_date","data de início do tratamento solicitado",                   "start date of requested treatment",
      "ar_finali",    "finalidade_tratamento","treatment_purpose","finalidade do tratamento",                                      "treatment purpose",
      "ar_cidtr1",    "cid_topografico1",  "topographic_cid1",    "CID topográfico 1º",                                            "topographic CID 1st",
      "ar_cidtr2",    "cid_topografico2",  "topographic_cid2",    "CID topográfico 2º",                                            "topographic CID 2nd",
      "ar_cidtr3",    "cid_topografico3",  "topographic_cid3",    "CID topográfico 3º",                                            "topographic CID 3rd",
      "ar_numc1",     "num_campos1",       "num_fields1",         "nº campo/inserções 1º",                                         "number of fields/inserts 1st",
      "ar_iniar1",    "inicio_trat1",      "start_treat1",        "data de início 1º",                                             "start date 1st",
      "ar_iniar2",    "inicio_trat2",      "start_treat2",        "data de início 2º",                                             "start date 2nd",
      "ar_iniar3",    "inicio_trat3",      "start_treat3",        "data de início 3º",                                             "start date 3rd",
      "ar_fimar1",    "fim_trat1",         "end_treat1",          "data de fim 1º",                                                "end date 1st",
      "ar_fimar2",    "fim_trat2",         "end_treat2",          "data de fim 2º",                                                "end date 2nd",
      "ar_fimar3",    "fim_trat3",         "end_treat3",          "data de fim 3º",                                                "end date 3rd",
      "ar_numc2",     "num_campos2",       "num_fields2",         "nº campo/inserções 2º",                                         "number of fields/inserts 2nd",
      "ar_numc3",     "num_campos3",       "num_fields3",         "nº campo/inserções 3º",                                         "number of fields/inserts 3rd",
      "ap_natjur",    "natureza_juridica", "legal_nature",        "código da natureza jurídica",                                   "legal nature code",
      ...
      "ab_numaih",    "numero_aih_1",          "aih_number_1",           "número da AIH",                 "AIH number",
      ...
      "ab_numaih2",   "numero_aih_2",          "aih_number_2",           "número da AIH",                 "AIH number",
      "ab_dtcirg2",   "data_cirurgia_2",       "surgery_date_2",         "data da cirurgia",              "surgery date",
      "ab_mesacom",   "meses_acompanhamento",  "followup_months",        "número em MESES de acompanhamento", "number of follow-up months",
      "ab_anoacom",   "ano_acompanhamento",    "followup_year",          "ano de acompanhamento",         "follow-up year",
      "ab_pontbar",   "pontuacao_baros",       "baros_score",            "pontuação de Baros12",          "Baros12 score",
      ...
      #ATD
      "atd_caract",   "caract_tratamento",       "treatment_characteristic",   "característica do tratamento",          "treatment type",
      "atd_dtpdr",    "data_1a_dialise",         "first_dialysis_date",       "data do início da primeira diálise",     "first dialysis date",
      "atd_dtcli",    "data_dialise_clinica",    "clinic_dialysis_date",      "início da diálise na clínica",          "clinic dialysis start date",
      "atd_acevas",   "acesso_vascular",         "vascular_access",           "tipo de acesso vascular",               "vascular access type",
      "atd_maisne",   "nefro_mais_1_ano",        "nephro_over_1y",            "nefrologia há mais de um ano",          "nephrology over 1 year",
      "atd_sitini",   "situacao_inicial",        "initial_status",            "situação inicial",                      "initial situation",
      "atd_sittra",   "situacao_transplante",    "transplant_status",         "situação de transplante",               "transplant situation",
      ...
      "atd_fosfor",   "fosforo",                 "phosphorus",                "nível de fósforo",                      "phosphorus level",
      "atd_ktvsem",   "ktv_semanal",             "weekly_ktv",                "kt/v semanal",                          "weekly ktv",
      "atd_tru",      "taxa_ureia",              "urea_reduction",            "taxa de redução de ureia",              "urea reduction rate",
      "atd_albumi",   "albumina",                "albumin",                   "nível de albumina",                     "albumin level",
      "atd_pth",      "pth",                     "pth_level",                 "hormônio da paratireoide",             "parathyroid hormone level",
      ...
      "atd_interc",   "intercorrencia_mes",      "intercurrence_this_month",  "internado por intercorrência clínica",  "clinical intercurrence",
      "atd_seperi",   "peritonite_mes",          "peritonitis_this_month",    "peritonite na diálise peritoneal",      "peritonitis in peritoneal dialysis",
      "ap_natjur",    "natureza_juridica",       "legal_nature_code",         "código da natureza jurídica",           "legal nature code"
    )
    ...
    if(dataset %in% c("datasus_siasus_sad","datasus_siasus_ps")) {
      harmonization_dat <- tibble::tribble(
        ...
        #SAD
        "cnes_exec",      "codigo_estabelecimento",  "establishment_code",       "código do estabelecimento no cnes",      "cnes establishment code",
        "gestao",         "gestor",                 "manager_code",             "código uf + município do gestor",        "manager location code",
        "condic",         "tipo_gestao",            "management_type",          "sigla do tipo de gestão",               "management type acronym",
        "ufmun",          "localizacao",            "location_code",            "código uf + município do estabelecimento", "establishment location code",
        ...
        "dt_process",     "data_processamento",     "processing_date",          "mês de processamento (aaaamm)",         "processing month (yyyymm)",
        "dt_atend",       "data_atendimento",       "attendance_date",          "mês do atendimento (aaaamm)",           "attendance month (yyyymm)",
        "cns_pac",        "cartao_sus",             "health_card_number",       "número do cartão nacional de saúde",    "national health card number",
        ...
        "racacor",        "raca_cor",               "race_color",               "raça/cor do paciente",                  "patient race/skin color",
        "etnia",          "etnia",                  "ethnicity",                "etnia do paciente",                     "patient ethnicity",
        "munpac",         "municipio_residencia",   "residence_municipality",   "código uf + município de residência",   "patient residence location",
        "mot_cob",        "motivo_saida",           "exit_reason",              "motivo de saída/permanência",           "reason for discharge/permanence",
        "dt_motcob",      "data_ocorrencia",        "occurrence_date",          "data da ocorrência",                    "occurrence date",
        "catend",         "carater_atendimento",    "care_character",           "caráter do atendimento",                "type of care provided",
        "cidpri",         "cid_principal",          "primary_diagnosis",        "diagnóstico principal (cid)",           "primary diagnosis (icd)",
        "cidassoc",       "cid_associada",          "associated_diagnosis",     "diagnóstico associado (cid)",           "associated diagnosis (icd)",
        "origem_pac",     "origem_paciente",        "patient_origin",           "origem do paciente",                    "patient origin code",
        "dt_inicio",      "data_inicio",            "start_date",               "data de início",                        "start date",
        "dt_fim",         "data_fim",               "end_date",                 "data de fim",                           "end date",
        "cob_esf",        "cobertura_esf",          "esf_coverage",             "cobertura da estratégia saúde da família", "family health strategy coverage",
        "cnes_esf",       "codigo_esf",             "esf_code",                 "código da unidade esf",                 "family health strategy unit code",
        "destinopac",    "destino_paciente",       "patient_destination",      "destino do paciente",                   "patient destination",
        "pa_proc_id",     "codigo_procedimento",    "procedure_code",           "código do procedimento ambulatorial",   "ambulatory procedure code",
        ...
        "pa_srv",         "servico_especializado",  "specialized_service",      "código do serviço especializado",       "specialized service code",
        "pa_clas_s",      "classificacao_servico",  "service_classification",   "classificação do serviço",              "service classification",
        "pa_equipe",      "codigo_equipe",          "team_code",                "código da equipe",                      "health team code",
        ...
        "inicio",      "inicio_atendimento",     "care_start_date",          "data de início do atendimento",         "care start date",
        "fim",         "fim_atendimento",        "care_end_date",            "data de fim do atendimento",            "care end date",
        "permanen",    "tempo_permanencia",      "care_duration",            "tempo de permanência em atendimento",   "duration of care",
        ...
        "serv",         "servico_cod",        "service_code",       "serviço especializado",      "specialized service",
        "class",        "classificacao_cod",  "classification_code","classificação do serviço",   "service class",
        "sit_rua",      "situacao_rua",       "homeless_status",    "situação de rua",            "homeless situation",
        "tp_droga",     "tipo_droga",         "drug_type",          "tipo de droga",              "drug type (A/C/O)",
        "loc_realiz",   "local_realizacao",   "realization_location","local de realização",       "place of service",
        "pa_proc_id",   "procedimento_id",    "procedure_code",     "ação realizada",             "performed procedure",
