load_dictionary <- function(dataset) {
  ...
  if (stringr::str_detect(dataset, "datasus_sih_rd")) {
    harmonization_dat <- tibble::tribble(
      ...
      "code_muni", "code_municipio", "city_code", "codigo do municipio", "city code",
      "name_muni", "name_municipio", "city_name", "nome do municipio", "city name",
      "code_state", "code_estado", "code_state", "codigo do estado", "state code",
      "abbrev_state", "abbrev_state", "abbrev_state", "sigla do estado", "state acronym",
      "legal_amazon", "legal_amazon", "legal_amazon", "amazonia legal", "legal amazonia",
