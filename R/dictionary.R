load_dictionary <- function(dataset) {
  ...
  if (stringr::str_detect(dataset, "datasus_sinasc")) {
    harmonization_dat <- tibble::tribble(
      ...
      "sexo", "sexo", "sex", "Sexo do bebe", "Baby's sex",
      "racacor", "cor_da_raca", "skin_color", "Cor da raca", "Race color",
      ...
      "difdata", "diferenca_data_obito_recebimento_original", "difference_between_date_of_death_and_original_receipt_date", "Diferenca entre a data de obito e data do recebimento original da DO ([dtnasc] –[dtrecorig])", "Difference between the date of death and the date of original receipt of the DO ([dtnasc] – [dtrecorig])",
