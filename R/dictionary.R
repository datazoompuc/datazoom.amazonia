load_dictionary <- function(dataset) {
  ...
  if (stringr::str_detect(dataset, "datasus_sinasc")) {
    harmonization_dat <- tibble::tribble(
      ...
      "consultas", "num_consultas_prenatal", "number_of_prenatal_consultations", "Consultas pre natal", "Prenatal consultations",
      ...
      "gestacao", "semanas_gestacao", "gestational_weeks", "Semanas de gestacão agrupado", "Weeks of gestation grouped",
