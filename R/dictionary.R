load_dictionary <- function(dataset) {
  ...
  if (stringr::str_detect(dataset, "datasus_sim")) {
    harmonization_dat <- tibble::tribble(
      ...
      "E000-E900", "t_endocrinas", "t_endocrine", "Doenças endocrinas, nutricionais e metabolicas", "Endocrine, nutritional and metabolic diseases", TRUE,
      ...
      "Q000-Q990", "t_malformacoes", "t_malformations", "Malformaçoes congenitas, deformidades e anomalias cromossomicas", "Congenital malformations, deformations and chromosomal abnormalities", TRUE,
      ...
      "Z000-Z990", "t_influencia", "t_influence", "Fatores que exercem influencia sobre o estado de saude e o contato com serviços de saude", "Factors influencing health status and contact with health services", TRUE,
      ...
      "B200-B240", "t_aids", "t_aids", "Doença pelo virus da imunodeficiencia humana [HIV]", "Human immunodeficiency virus [HIV] disease", TRUE,
      ...
      "sexo", "sexo", "sexo", "Sexo:\n0: Ignorado\n1: Masculino\n2: Feminino", "", FALSE,
      "racacor", "racacor", "racacor", "Raça/Cor:\n1:Branca\n2:Preta\n3:Amarela\n4: Parda\n5: Indigena", "", FALSE,
      "estciv", "estciv", "estciv", "Estado civil:\n1: Solteiro\n2: Casado\n3: Viuvo\n4: Separado judicialmente\n9: Ignorado", "", FALSE,
      "esc", "esc", "esc", "Escolaridade, Anos de estudo concluidos:\n1: Nenhuma\n2: 1 a 3 anos\n3: 4 a 7 anos\n4: 8 a 11 anos\n5: 12 e mais\n9: Ignorado", "", FALSE,
      "ocup", "ocup", "ocup", "Ocupaçao, conforme a Classificaçao Brasileira de Ocupaçoes (CBO-2002)", "", FALSE,
      ...
      "ocupmae", "ocupmae", "ocupmae", "Ocupaçao da mae, conforme codificaçao de OCUPACAO", "", FALSE,
      ...
      "gestacao", "gestacao", "gestacao", "Semanas de gestaçao:\n9: Ignorado\n1: Menos de 22 semanas\n2: 22 a 27 semanas\n3: 28 a 31 semanas\n4: 32 a 36 semanas\n5: 37 a 41 semanas\n6: 42 semanas e mais", "", FALSE,
      "parto", "parto", "parto", "Tipo de parto:\n9: Ignorado\n1: Vaginal\n2: Cesareo", "", FALSE,
      "obitoparto", "obitoparto", "obitoparto", "Morte em relaçao ao parto, conforme tabela:\n9: Ignorado\n1: Antes\n2: Durante\n3: Depois", "", FALSE,
      ...
      "linhaa", "linhaa", "linhaa", "Linha A do atestado, conforme a Classificaçao Internacional de Doença (CID), 10a. Revisao", "", FALSE,
      "linhab", "linhab", "linhab", "Linha B do atestado, conforme a Classificaçao Internacional de Doença (CID), 10a. Revisao", "", FALSE,
      "linhac", "linhac", "linhac", "Linha C do atestado, conforme a Classificaçao Internacional de Doença (CID), 10a. Revisao", "", FALSE,
      "linhad", "linhad", "linhad", "Linha D do atestado, conforme a Classificaçao Internacional de Doença (CID), 10a. Revisao", "", FALSE,
      "linhaii", "linhaii", "linhaii", "Linha II do atestado, conforme a Classificaçao Internacional de Doença (CID), 10a. Revisao", "", FALSE,
      "causabas", "causabas", "causabas", "Causa basica, conforme a Classificaçao Internacional de Doença (CID), 10a. Revisao", "", FALSE,
      ...
      "fonte", "fonte", "fonte", "Fonte da informaçao, conforme a tabela:\n9: Ignorado\n1: Boletim de Ocorrencia\n2: Hospital\n3: Familia\n4: Outra", "", FALSE,
      "tppos", "tppos", "tppos", "obito investigado 1-Sim, 2- Nao", "", FALSE,
      "dtinvestig", "dtinvestig", "dtinvestig", "Data de investigaçao", "", FALSE,
      "causabas_o", "causabas_o", "causabas_o", "Causa basica original, a primeira informaçao que entra no sistema", "", FALSE,
      ...
      "fonteinv", "fonteinv", "fonteinv", "Fonte de investigaçao:\n1 Comite de Morte Materna e/ou Infantil\n2 Visita domiciliar / Entrevista familia\n3 Estab Saude / Prontuario\n4 Relacion com outros bancos de dados\n5 S V O\n6 I M L\n7 Outra fonte\n8 Multiplas fontes\n9 Ignorado", "", FALSE,
      "dtrecebim", "dtrecebim", "dtrecebim", "Data de recebimento no nivel central, data da ultima atualizaçao do registro", "", FALSE,
