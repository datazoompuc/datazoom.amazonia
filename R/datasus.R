...
load_datasus <- function(dataset = NULL, raw_data = NULL, time_period = NULL,
                         language = "eng") {
  if (language == "pt") {
    warning("A fun\u00e7\u00e3o `load_datasus` n\u00e3o faz mais parte do pacote e n\u00e3o est\u00e1 mais dispon\u00edvel. As funcionalidades ser\u00E3o integradas no novo pacote chamado Datazoom Sa\u00FAde, atualmente em desenvolvimento.",
            call. = FALSE)
  } else {
