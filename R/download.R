sidra_download = function(sidra_code = NULL,year,geo_level = 'municipality',
  ...
  # f = geo %>% filter(!(code_muni %in% unique(dat_uf$`Munic√≠pio (C√≥digo)`)))
...
datasets_link = function(){
  ...
  link = tibble::tribble(~survey,~dataset,~sidra_code,~classific,~category,~available_time,~available_geo,~link,
   ...
   'PAM-IBGE','pam_all_crops',5457,"all", "all", '1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','pam_permanent_crops',1613, 'c("c82") , "all" ',"all",'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','pam_temporary_crops',1612,"all", "all", '1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','pam_corn',839,"all", "all", '2003-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','pam_potato',1001,"all", "all", '2003-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','pam_peanut',1000,"all", "all", '2003-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','pam_beans',1002, "all", "all", '2003-2020', 'Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',

   ###

   'PAM-IBGE','Total',1613,c("c82"), list(0), '1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Abacate',1613,c("c82"), list(2717) , '1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Algod„o arbÛreo (em caroÁo)',1613, c("c82"), list(718), '1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','AÁaÌ',1613,c("c82"), list(45981), '1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Azeitona',1613,c("c82"), list(2719), '1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Banana (cacho)',1613, c("c82"), list(2720), '1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Borracha (l·tex coagulado)', 1613, c("c82"), list(2721),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Borracha (l·tex lÌquido)', 1613, c("c82"), list(40472),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Cacau (em amÍndoa)', 1613, c("c82"), list(2722),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','CafÈ (em gr„o) Total', 1613, c("c82"), list(2723),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','CafÈ (em gr„o) Ar·bica', 1613, c("c82"), list(31619),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','CafÈ (em gr„o) Canephora', 1613, c("c82"), list(31620),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Caju', 1613, c("c82"), list(40473),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Caqui', 1613, c("c82"), list(2724),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Castanha de caju', 1613, c("c82"), list(2725),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Ch·-da-Ìndia (folha verde)', 1613, c("c82"), list(2726),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Coco-da-baÌa*', 1613, c("c82"), list(2727),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','DendÍ (cacho de coco)', 1613, c("c82"), list(2728),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Erva-mate (folha verde)', 1613, c("c82"), list(2729),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Figo', 1613, c("c82"), list(2730),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Goiaba', 1613, c("c82"), list(2731),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Guaran· (semente)', 1613, c("c82"), list(2732),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Laranja', 1613, c("c82"), list(2733),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Lim„o', 1613, c("c82"), list(2734),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','MaÁ„', 1613, c("c82"), list(2735),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Mam„o', 1613, c("c82"), list(2736),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Manga', 1613, c("c82"), list(2737),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Maracuj·', 1613, c("c82"), list(2738),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Marmelo', 1613, c("c82"), list(2739),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Noz (fruto seco)', 1613, c("c82"), list(2740),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Palmito', 1613, c("c82"), list(90001),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Pera', 1613, c("c82"), list(2741),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','PÍssego', 1613, c("c82"), list(2742),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Pimenta-do-reino', 1613, c("c82"), list(2743), '1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Sisal ou agave (fibra)', 1613, c("c82"), list(2744),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Tangerina', 1613, c("c82"), list(2745), '1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Tungue (fruto seco)', 1613, c("c82"), list(2746),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Urucum (semente)', 1613, c("c82"), list(2747), '1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Uva', 1613, c("c82"), list(2748), '1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   ...
   # DETER (Somente Amaz√¥nia Legal e Cerrado)
   ...
   # Processos miner√°rios inativos - Brasil
