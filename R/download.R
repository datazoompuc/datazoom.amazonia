...
datasets_link = function(){
  ...
  link = tibble::tribble(~survey,~dataset,~sidra_code,~classific,~category,~available_time,~available_geo,~link,
   ...
   'PAM-IBGE','pam_permanent_crops', '1613/c82/all', '1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   ...
   'PAM-IBGE','Total', '1613/c82/0', '1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Abacate', '1613/c82/2717' , '1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Algodão arbóreo (em caroço)', '1613/c82/718', '1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Açaí', '1613/c82/45981', '1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Azeitona', '1613/c82/2719', '1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Banana (cacho)', '1613/c82/2720', '1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Borracha (látex coagulado)', '1613/c82/2721','1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Borracha (látex líquido)', '1613/c82/40472','1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Cacau (em amêndoa)', '1613/c82/2722','1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Café (em grão) Total', '1613/c82/2723','1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Café (em grão) Ar?ábica', '1613/c82/31619','1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Café (em grão) Canephora', 1613, c("c82"), list(31620),'1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Caju', '1613/c82/40473','1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Caqui', '1613/c82/2724','1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Castanha de caju', '1613/c82/2725','1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Chá-da-Índia (folha verde)', '1613/c82/2726','1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Coco-da-baía', '1613/c82/2727','1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Dendê (cacho de coco)', '1613/c82/2728','1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   ...
   'PAM-IBGE','Guaraná (semente)', '1613/c82/2732','1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Laranja', '1613/c82/2733','1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Limão', '1613/c82/2734','1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Maçã', '1613/c82/2735','1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Mamão', '1613/c82/2736','1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Manga', '1613/c82/2737','1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   'PAM-IBGE','Maracujá', '1613/c82/2738','1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
   ...
   'PAM-IBGE','Pêssego', '1613/c82/2742','1974-2020','Country, State, Municipality','https://sidra.ibge.gov.br/pesquisa/pam/tabelas',
