...
datasets_link <- function() {
  ...
  link <- tibble::tribble(
    ...
    "CENSO_AGRO-IBGE" , "animal_species_production" , "281" , "1970, 1975, 1980, 1985, 1995, 2006" , "Country, Region, State" , "https://sidra.ibge.gov.br/pesquisa/censo-agropecuario/series-temporais" ,
