...
load_pam_permanent <- function(years, aggregation_level = "country", language = "pt", long = FALSE) {
  ...
  micro <- c(
    29006, 29001, 29007, 29022, 29027, 29019, 29002, 29018, 29014, 29012, 29026, 29031, 29009,
...
#' @examples
#' \dontrun{
#' datazoom.amazonia::load_pam_temporary(2010, aggregation_level = "country")
#' }
#'
...
#' @examples
#' \dontrun{
#' datazoom.amazonia::load_pam_main(2007, aggregation_level = "country")
#' }
#'
